...
### Репозитории и сервисы (GitHub, документация, платформы)
...
### Репозиторий и внутренняя методология CMW

- [cmw-rag (GitHub)](https://github.com/arterm-sedov/cmw-rag)
- [AGENTS.md — руководство для агентов в репозитории](../../AGENTS.md)
- [Методология исследований в `docs/research/`](./AGENTS.md)
