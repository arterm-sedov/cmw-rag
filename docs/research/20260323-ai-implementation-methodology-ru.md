...
**Модели:**
- **Cursor Composer 2** — код на уровне Opus 4.6 / GPT-5.4; в публичных прайсах фигурирует порядок **~42,5 ₽/млн** входных токенов (эквивалент **~0,5 USD/млн** при пересчёте **85 ₽/USD**)
