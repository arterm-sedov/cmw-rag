...
- [Профиль on-prem GPU в проектах CMW](./20260325-research-report-sizing-economics-main-ru.md#sizing_onprem_gpu_profile_cmw) (реф. GeForce 24 ГБ, 4090 48 ГБ коммерческая аренда, RTX PRO 6000 Blackwell 96 ГБ)
...
**Основания и границы применимости:** **инженерная практика CMW** — открытые репозитории **cmw-rag**, **cmw-mosec**, **cmw-vllm**, **cmw-platform-agent** (код, конфигурации, README). **Рыночные цифры, опросы и бенчмарки** — из публичных и отраслевых материалов; они **не** отражают замеры CMW у конкретных заказчиков, если такие проекты отдельно не задокументированы. **Синтез и рекомендации** — экспертиза CMW по внедрению и сопровождению под резидентный контур РФ (152-ФЗ, локализация, локальные облака) с учётом ограничений зарубежных источников для вашего контура.
...
- **AI-first организация:** подкаст с руководством иллюстрирует постановку продуктовой и корпоративной модели «вокруг ИИ»; из него **не** следует состав поставки **корпоративный RAG-контур**, **агентный слой платформы (CMW Platform)** или обязательный стек инференса. См. «_[AI-first стратегия: подкаст (пост канала)](https://t.me/Redmadnews/5170)_»; полный выпуск — «_[Подкаст «Ноосфера» #129 (YouTube)](https://www.youtube.com/watch?v=jTKhg1jqF_M)_».
...
#### MOSEC, vLLM и репозитории CMW {: #method_mosec_vllm_cmw_repos }
...
**Репозитории CMW** (прикладные комплекты вокруг MOSEC и vLLM; подробности развёртывания — в публичной документации каждого модуля):
...
-   **60-90 дней:** Финализация масштабирования LLM на **инференс на базе vLLM**, стабилизация **корпоративный RAG-контур** и (при внедрении) **агентный слой платформы (CMW Platform)**, подготовка комплекта отчуждения, аудит на соответствие новому закону об ИИ.
...
### Стратегия внедрения и обучение руководителей (вне поставки CMW) {: #method_implementation_strategy_manager_training }
