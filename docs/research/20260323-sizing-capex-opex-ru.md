...
Для **российских КП** оба шлюза имеют **только иллюстративный** характер в части цен и TCO продакшн-решений: тарифы Zen — в **USD** на стороне сервиса; OpenRouter — преимущественно **иностранные исполнители** и валютный биллинг. **Не смешивать** эти ориентиры с тарифами **Cloud.ru / Yandex Cloud / SberCloud** из таблиц выше по документу и **не** использовать Zen или OpenRouter как подразумеваемый **продакшн**-контур для ПД без отдельной правовой и ИБ-оценки.
