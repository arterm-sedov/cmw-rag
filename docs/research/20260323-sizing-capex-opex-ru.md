...
В 2026 году экономика ИИ-решений определяется не только стоимостью GPU, но и эффективностью управления токенами (Token Economics). Переход на локальный инференс (**cmw-mosec**, **cmw-vllm**) позволяет снизить TCO на 60-70% при достижении порога утилизации в 40-60%; **cmw-rag** и **cmw-platform-agent** задают суммарный профиль запросов к этому инференсу и к облачным API.

**Ключевой вывод:** Для малого и среднего бизнеса (SMB) наиболее эффективным является использование российских облачных провайдеров (Cloud.ru, Yandex) с тарифами от 12 ₽/млн токенов. Для крупных корпораций (Enterprise) On-Prem развертывание на базе RTX 4090 или A100 окупается за 4-6 месяцев.
...
### Cloud.ru (Evolution Foundation Models) [[источник]](https://cloud.ru/documents/tariffs/evolution/foundation-models)
...
### Yandex Cloud (YandexGPT) [[источник]](https://www.akm.ru/eng/press/yandex-b2b-tech-has-opened-access-to-the-largest-language-model-on-the-russian-market/)

*   **Цена:** ~50 копеек за 1,000 токенов (0.5 ₽/1,000 токенов)
*   **Эквивалент:** 500 ₽ за 1 млн токенов
*   **Модели:** YandexGPT Pro 5.1, Alice AI LLM

### SberCloud (GigaChat API) [[источник]](https://developers.sber.ru/docs/ru/gigachat/tariffs/legal-tariffs)
...
**Заключение:** Экосистема CMW (**cmw-rag**, **cmw-mosec**, **cmw-vllm**, **cmw-platform-agent**) обеспечивает гибкую архитектуру для оценки и оптимизации затрат на AI-инфраструктуру с учётом российских ограничений и глобальных трендов.

---

## Глобальный рынок ИИ-инфраструктуры: CapEx и OpEx (2025-2026)

### Крупные инвестиции Big Tech [[источник]](https://introl.com/blog/ai-infrastructure-financing-capex-opex-gpu-investment-guide-2025)
...
### TCO Calculator: On-Prem vs Cloud [[источник]](https://slyd.com/resources/tco-calculator)
...
### GPU Hardware Pricing [[источник]](https://www.swfte.com/blog/private-ai-enterprises-onprem-economics)
...
### Depreciation и Hardware Lifecycle [[источник]](https://introl.com/blog/ai-infrastructure-financing-capex-opex-gpu-investment-guide-2025)
...
### Throughput Estimation [[источник]](https://www.runpod.io/articles/guides/llm-inference-optimization-playbook)
...
### Размер рынка [[источник]](https://www.imarcgroup.com/russia-artificial-intelligence-market)
...
### GPU Cloud в России [[источник]](https://dataoorts.com/top-5-plus-gpu-cloud-providers-in-russia/)
...
### CLI вместо MCP [[источник]](https://t.me/ai_archnadzor/190)
...
### Кейс: Qwen3.5-397B на M3 Max 48GB [[источник]](https://t.me/llm_under_hood)
...
### Прогноз McKinsey [[источник]](https://introl.com/blog/ai-infrastructure-capacity-planning-forecasting-gpu-2025-2030)
...
### Слои AI-инфраструктуры [[источник]](https://pitchgrade.com/research/ai-infrastructure-primer)
...
### Три измерения ROI [[источник]](https://larridin.com/blog/state-of-enterprise-ai-in-2025)
...
### Экономический эффект ИИ в России [[источник]](https://yakovpartners.com/publications/ai-2025/)
