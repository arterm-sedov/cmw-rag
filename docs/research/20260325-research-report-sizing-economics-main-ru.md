...
**Примечание:** Cursor утверждает, что Composer 2 сопоставим по качеству с топовыми моделями, но существенно дешевле. Актуальные цены — на сайте провайдера; для КП фиксируйте дату и валюту контракта.
