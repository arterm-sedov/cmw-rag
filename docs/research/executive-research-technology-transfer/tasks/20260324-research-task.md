...
- **Границы ссылок:** Внутренние `.md`-ссылки допустимы только в глубоком комплекте для навигации. В кратких C-level резюме и внешних версиях — исключить.
...
3. **Приложения** — источники (A), отчуждение ИС/кода (B), референс-стек Comindware (C), комплаенс и observability (D).
4. **Два C-level резюме (1–2 стр.)** — выжимка п.1 и п.2 для сейлс-китов (без внутренних путей).
...
3. Два кратких **C-level резюме** (без путей к репозиториям; см. **§1б**).
4. Приложения A–D по ролям из **§1**, п.3. Содержательный каркас — **§13**.
...
- C-level резюме **автономны** (не ссылаются на структуру репозитория).
- **Согласованность метрик:** цифры ведутся из канонического отчёта, противоречия устранены или помечены.
- Краткие резюме включают блок условного курса валют.
...
- **Краткие C-level резюме:** Для цифр достаточно **одного канонического** источника или ссылки по названию на основной отчёт (без путей).
