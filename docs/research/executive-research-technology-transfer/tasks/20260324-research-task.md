...
## 0. Исполнительский контракт для ИИ-агента (обязателен перед правками)

Файл `tasks/` — **инструкция для автора**, `report-pack/` — **читательский продукт для C-level**.

- **Цель:** Обеспечить руководство материалами для принятия решений и формирования офферов (внедрение, отчуждение, экономика, комплаенс).
- **Аудитория `report-pack/`:** C-level и техдиректора, принимающие решения по бюджету и архитектуре.
- **Критерий успеха:** Текст можно перенести в бриф или коммерческое предложение **без дополнительных пояснений автора**.
- **Запрещено в `report-pack/`:** Авторские ремарки, «мета»-формулировки («в этом документе...», «смотри раздел задачи»), ссылки на workflow и устройство репозитория.
- **Границы ссылок:** в **глубоком** комплекте — гиперссылки `.md#якорь` между файлами и публичные URL; в **едином C-level резюме** и во **внешних** копиях — без путей к репозиторию (детали — **§4**).

### 0.1 Быстрая проверка (Чек-лист)

- Текст понятен руководителю без инструкций «как его читать»?
- Содержит ли он явный ответ на вопрос «что это значит для оффера Comindware»?
- Исключены ли авторские ремарки и task-oriented wording?
- Подтверждены ли ключевые тезисы доказательствами?
- Сохранён ли бизнес-фокус: **enable decision and offer design**, а не описание процесса подготовки?

## 1. Цель

**Бизнес-цель:** Единая доказательная база для руководства и продаж по **внедрению, отчуждению, сайзингу и экономике** (TCO) ИИ в РФ, с упором на суверенную архитектуру.

**Артефакты:**

1. **Глубокий отчёт по методологии** — фазы внедрения, TOM, отчуждение (KT), риски (в т.ч. РФ).
2. **Глубокий отчёт по сайзингу** — факторы стоимости, сценарии, CapEx/OpEx, тарифы (согласовано с методологией).
3. **Приложения** — источники и навигация (A), отчуждение ИС/кода (B), референс-стек Comindware (C), комплаенс и observability (D), рыночные и технические сигналы (E), расширенное чтение (F).
4. **Единое C-level резюме (1–2 стр.)** — коммерческое обоснование, методология и экономика в одном документе для сейлс-китов (без внутренних путей к репозиторию); файл — **§1б**.
...
**Имена файлов читательского комплекта** (техническая ведомость для исполнителя; префикс `20260325-` — сплит основных отчётов и приложений A–F; `20260331-` — единое резюме) — **§1б**. Каталог публикации: `docs/research/executive-research-technology-transfer/report-pack/`.

### 1б. Ведомость файлов в `report-pack/`
...
| Приложение F — расширенное чтение и внешние подборки | `20260325-research-appendix-f-extended-reading-ru.md` |
| Единое резюме для руководства: коммерция, методология и экономика (C-level; без путей к репозиторию) | `20260331-research-executive-unified-ru.md` |

**Устаревшие имена (не использовать в новых правках; заменены строкой выше):** `20260325-comindware-ai-commercial-offer-ru.md`, `20260325-research-executive-methodology-ru.md`, `20260325-research-executive-sizing-ru.md`.

## 1а. Назначение пакета и позиционирование

- **Продукт Comindware:** Внедрение и сопровождение корпоративного ИИ под зонтиком референс-экосистемы.
- **Назначение отчётов:** Внутренняя база для подготовки брифов и сейлс-китов (не платный SKU).
- **Инженерная база:** Практика из `cmw-rag`, `cmw-mosec`, `cmw-vllm`, `cmw-platform-agent`. Остальное — честные внешние бенчмарки с атрибуцией.
- **Суверенный дефолт (РФ):** Локализация, 152-ФЗ, локальные облака. Глобальный опыт (US/КНР) служит технологическим фоном.
...
- **Сохранять релевантный контент.** Добавлять новый, закрывая пробелы.
- Удалять только явно устаревший материал.
- Финальные документы: точные, доказательные, уровня **C-level**.

### Самостоятельность резюме и аудитория (C-level, стейкхолдеры)

**Единое C-level резюме** и любые **внешне передаваемые** версии текстов комплекта готовятся как **самостоятельные** документы: их передают на **дальнейшую вычитку и доработку** стейкхолдерам, у которых **нет** обязанности открывать этот репозиторий или любые другие внутренние репозитории. **Глубокий** комплект (основные отчёты и приложения A–F) **снабжён гиперссылками** между файлами и якорями (`.md#якорь`); при экспорте в PDF такие ссылки остаются **кликабельными** и служат навигации читателя. Ограничения для резюме и внешних копий — в следующем пункте.

- **Не указывать** в тексте **внешне передаваемых** копий и в **едином C-level резюме** (см. **§1б**, `20260331-research-executive-unified-ru.md`) **конкретные файлы, каталоги, относительные пути** репозитория (или иных репозиториев), **ссылки на `.md` / ветки / папки в git** и аналогичные внутренние адреса — **если только** такая отсылка **не** нужна для проверяемости тезиса и **явно** оправдана (исключение должно быть редким). В **глубоком** комплекте наоборот **поддерживать** осмысленные перекрёстные ссылки (как в предыдущем абзаце).
...
4. Синтезировать результаты в **глубокий комплект** (основные отчёты и приложения — **§1**, п.1–3, **§1б**) и в **единое C-level резюме** (**§1**, п.4), если оно входит в объём задачи.
5. Провести повторную проверку на соответствие охвату и ограничениям.
6. Подготовить финальные **отшлифованные версии**.
7. После существенных правок **глубокого комплекта** — **синхронизировать** **единое C-level резюме** (см. **§1**, п.4 и **§1б**) с каноническими формулировками, цифрами и оговорками **основных** отчётов по методологии и по сайзингу.

## 8. Итоговые артефакты и критерии приёмки

### Результаты

1. Самодостаточный отчёт по **методологии внедрения и отчуждения ИИ** (см. **§13.1**).
2. Самодостаточный отчёт по **сайзингу, CapEx и OpEx** (см. **§13.2**).
3. **Единое C-level резюме** (без путей к репозиториям; см. **§1б**).
4. Приложения A–F по ролям из **§1**, п.3. Содержательный каркас основных отчётов — **§13**; приложения E–F дополняют сигналы и справочное чтение без дублирования канонических цифр.

### Критерии приёмки

- Отчёты структурированы, прикладного характера, опираются на **глубокое исследование** и внутренние данные.
- Покрыты внедрение, отчуждение, экономика и РФ-комплаенс.
- Telegram-инсайты полностью интегрированы (текст извлечён на 100%).
- C-level резюме **автономно** (не ссылается на структуру репозитория).
- **Согласованность метрик:** цифры ведутся из канонического отчёта, противоречия устранены или помечены.
- Единое резюме включает блок условного курса валют (или явную отсылку к каноническому блоку в Приложении A).
...
### 12.1 Доказательность

- **Глубокий комплект:** На каждый тезис — минимум **3 источника** (из них ≥1 первого приоритета).
- **Единое C-level резюме:** для цифр достаточно **одного канонического** источника или ссылки по **человекочитаемому названию** основного отчёта (без путей к файлам репозитория).
- Количественные оценки (ROI, TCO) подтверждать первоисточником там, где они задаются впервые.

### 12.2 Свежесть

- Приоритет: последние 12-24 месяца.
- Стандарты/законы: проверять действующую редакцию.

### 12.3 Прослеживаемость

- Вести журнал: `Тезис | Источник | Тип | Дата | Надежность | Комментарий`

### 12.4 Конфликты

- Фиксировать расхождения источников и давать объяснения по допущениям.
...
1. **Сбор данных:** Охвачены все темы, нет «пустых» разделов.
2. **Синтез:** Каждый вывод подтверждён источниками.
3. **Перед финализацией:** Текст читается на уровне руководства (C-level).
4. **Финал:** Релевантные старые материалы сохранены, шум удалён.
5. **Согласованность комплекта:** Единый курс пересчёта, даты и определения CapEx/OpEx. Исключено дублирование или смешивание метрик опросов.
...
## 17. Стандарты оформления и терминологии

### 17.1 Числа и валюты

- **Запись чисел:** Разделитель групп — пробел (`1 000 000`), десятичный — запятая (`2,5%`). Сокращения: **тыс. руб.**, **млн руб.**, **млрд руб.**
- **Валюты:** Только **российские рубли (руб.)**. Условный курс: `1 USD = 85 RUB` (все старые данные в USD пересчитать).
- **Раскрытие курса:** В резюме явно указывать: *«Курс пересчёта зарубежных прайсов: 1 USD = 85 RUB. Для КП заказчику — курс ЦБ на дату сметы»*. Допускается строка чувствительности (±10% курса для GPU).

### 17.2 Язык и терминология

- **Приоритет русского языка:** Использовать устоявшиеся бизнес-термины (например, *операционная модель*).
- **Англоязычные термины:** Только при отсутствии перевода или если это стандарт (RAG, LLM). При первом упоминании — перевод в скобках.
- **Стиль:** Деловой, лаконичный, без «воды», для принятия решений (C-level).

### 17.3 Структура и подача (McKinsey/BCG Style)

Финальные резюме — это **one-pagers** (1-2 страницы), следуя логике **SCQA** и **MECE**:

1. **Situation:** Контекст рынка.
2. **Complication:** Вызов или возможность.
3. **Question:** Вопрос, решаемый в отчёте.
4. **Answer:** Рекомендации с расчётами (фокус на "So What?").

*(Общие правила Markdown — в `docs/research/AGENTS.md`)*.

**Ключевые акценты:**

- Одна мысль на раздел.
- Фокус на цифрах (ROI, экономия).
- Визуальная логика (списки, таблицы, индикаторы рисков — «светофор»).
- Выделение трендов 2025-2026 гг.
