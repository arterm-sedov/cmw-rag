...
Валюта и Курс USD/RUB для иллюстративных ориентиров — см. [приложение A](./20260325-research-appendix-a-index-ru.md#app_a_fx_policy).

Для смет и договорных КП фиксируйте курс и прайс на дату.
...
-   **Стоимость:** ~212 500 руб. (GPU + CPU + ОЗУ + Хранилище; фактический CapEx для **48 ГБ / PRO 6000** — по поставщику)
...
-   **Стоимость:** ~680 000 – 1 020 000 руб.
...
-   **Стоимость:** ~4 250 000 – 17 000 000 руб.+ (кластер 4-8 GPU)
...
4.  **Прерываемые инстансы:** Yandex Cloud и другие российские провайдеры предлагают прерываемые (preemptible) GPU-инстансы со скидкой до 40–60% для некритичных рабочих нагрузок (эксперименты, тестирование, обучение с контрольными точками).
