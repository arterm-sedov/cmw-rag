# Build document agent architecture report PDF
# Requires: cbap-mkdocs-ru venv (Python 3.13), GTK3, Node.js + mmdc
# Usage: .\build_doc_agent_pdf.ps1
#
...
$env:MKDOCS_PDF_OUTPUT_FILENAME = "Comindware. Архитектура агента обработки документов. $dateStr.pdf"
$configPath = Join-Path $scriptDir.FullName "mkdocs_doc_agent_pdf.yml"
$outputPath = Join-Path $scriptDir.FullName ".site-doc-agent\$env:MKDOCS_PDF_OUTPUT_FILENAME"

Write-Host "Building document agent architecture report PDF..." -ForegroundColor Cyan
