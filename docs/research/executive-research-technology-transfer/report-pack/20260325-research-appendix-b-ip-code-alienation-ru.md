...
- **Реестр доверенных моделей:** публикация открытых весов **не заменяет** проверку допуска модели для госсектора и КИИ (см. _«[Управление рисками и комплаенс](./20260325-research-appendix-d-security-observability-ru.md#app_d_risk_management_compliance)»_).
