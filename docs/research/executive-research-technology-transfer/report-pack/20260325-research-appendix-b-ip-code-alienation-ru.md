...
Материал помогает **согласовать передачу контура**: что входит в комплект (код, конфигурации, данные, модели, регламент эксплуатации (runbook)), как учитываются **лицензии и IP**, какие **критерии приёмки** закрепить в договоре. **Сметные последствия** и TCO — в _«[Отчёт. Сайзинг и экономика](./20260325-research-report-sizing-economics-main-ru.md#sizing_pack_overview)»_.

## Обзор для продаж и руководства: «передача способности» (KT/IP/BOT) {: #app_b_capability_transfer_overview }
...
**Что решает на уровне руководства:**
...
- **Коммерческая прозрачность**: что именно включено в поставку и передачу, а что является внутренними рабочими материалами исполнителя (и должно быть явно перечислено в договоре, если требуется).
