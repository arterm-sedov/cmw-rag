...
Материал помогает **согласовать передачу контура**: что входит в комплект (код, конфигурации, данные, модели, регламент эксплуатации (runbook)), как учитываются **лицензии и IP**, какие **критерии приёмки** закрепить в договоре. **Сметные последствия** и TCO — в [«Основной отчёт: сайзинг и экономика»](./20260325-research-report-sizing-economics-main-ru.md#sizing_pack_overview).
...
- **Суверенность и контроль**: какие активы принадлежат заказчику (код/данные/модели/конфигурации), где проходят границы лицензий и субпроцессоров.
