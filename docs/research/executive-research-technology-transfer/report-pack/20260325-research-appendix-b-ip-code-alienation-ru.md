...
**Важно:** продукт [OpenCode](https://opencode.ai/) (открытый AI coding agent) и внутренние каталоги планирования в репозиториях Comindware — **разные сущности**; не смешивать их в переговорах и в договорной документации.
