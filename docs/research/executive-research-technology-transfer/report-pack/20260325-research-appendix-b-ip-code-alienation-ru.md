...
**Экономика:**
- Выбор решения для команды разработки зависит от профиля:
  - **Облачные решения (SaaS):** GitHub Copilot Business — **~8 000–17 000 руб./мес** на 5–10 инженеров; Cursor Teams / Windsurf — **~17 000–34 000 руб./мес**.
    - **Локальные модели (on-prem GPU):** Диапазон **~127 500 – 212 500 руб./мес** соответствует стоимости выделенных GPU-серверов (A100/H100) с инфраструктурой.
    - **OpenCode Team** — решение для enterprise-команд с требованиями к суверенности данных и контролю:
        - OpenCode Go: **~850 руб./мес на пользователя** (базовый), **~1 700 руб./мес на пользователя** (Pro)
        - OpenCode Enterprise: индивидуальные условия (включая on-prem развёртывание, SSO, внутренний AI-шлюз)
        - Для команд 5–10 инженеров: **~4 250–17 000 руб./мес** (OpenCode Go)
