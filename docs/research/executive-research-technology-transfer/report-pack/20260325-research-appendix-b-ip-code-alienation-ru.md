...
- Для выбора модели взаимодействия (управляемый сервис vs BOT vs создание и передача) — опираться на таблицу [«Модели поставки и передачи»](#app_b_delivery_transfer_models_ip_knowledge).
...
- **Документация:** архитектура, эксплуатационный регламент, регламенты эксплуатации, критерии приёмки и журнал ограничений.
...
| Политика наблюдаемости (сэмплирование, ретенция, маскирование ПДн) и схема экспорта телеметрии | Согласованность с 152-ФЗ и воспроизводимость разборов инцидентов |
