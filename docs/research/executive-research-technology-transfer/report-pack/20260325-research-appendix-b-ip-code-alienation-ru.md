...
**Экономика:**
- Замена подписки на облачный coding-агент на локальные модели требует отдельного анализа:
  ...
  - **Локальные модели (on-prem GPU):** Диапазон **~127 500 – 212 500 руб./мес** соответствует стоимости выделенных GPU-серверов (A100/H100) с инфраструктурой, а не облачным подпискам.
