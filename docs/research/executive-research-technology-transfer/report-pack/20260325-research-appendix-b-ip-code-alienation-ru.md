---
title: 'Приложение A. Отчуждение ИС и кода: KT, IP, лицензии, критерии приёмки'
date: '2026-04-06'
status: 'v2'
tags:
    - комплаенс
...
# Приложение A. Отчуждение ИС и кода: KT, IP, лицензии, критерии приёмки {: #app_b_pack_overview }
