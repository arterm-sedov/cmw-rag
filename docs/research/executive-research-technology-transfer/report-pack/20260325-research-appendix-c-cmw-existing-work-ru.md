...
Здесь представлены сведения о том, **что именно покрывает референс-стек Comindware сегодня**: границы модулей, роли в архитектуре и различие между **поставляемыми артефактами** и **методологическими рекомендациями**.
...
- Дайте покупателю быстрый ответ «что у **Comindware** уже реально есть» и где границы «референс-стека» vs «методология».
...
- Не забывайте, что названия модулей в отчёте — **роли компонентов** и иллюстративный референс, а коммерческий состав фиксируется договором.
- Снижайте риск ожиданий: состав стека явно ограничен — нет «магии», каждый модуль имеет документацию и тесты.
