...
- **EU AI Act — 2 августа 2026** (для сделок с EU-составляющей): по **действующему** Регламенту с этой даты — основной массив правил (высокий риск, прозрачность); **Digital Omnibus** (2025–2026) может сдвинуть часть обязательств — планируйте по базовому тексту и отслеживайте **трилог**; применимость зависит от роли и использования в ЕС — при EU-клиентах провести юридическую классификацию до вывода на рынок; штрафы (в т.ч. «большее/меньшее» для крупных субъектов vs МСП), даты и охват — _«[Международный регуляторный контекст: EU AI Act](./20260325-research-appendix-d-security-observability-ru.md#app_d__eu_ai_act_context)»_.
