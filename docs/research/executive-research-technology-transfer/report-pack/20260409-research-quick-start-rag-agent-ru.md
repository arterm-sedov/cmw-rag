---
title: 'Быстрый старт: создание агента с доступом к знаниям и Comindware Platform'
date: '2026-04-09'
status: 'v2'
tags:
    - RAG
...
# Быстрый старт: создание агента с доступом к знаниям и Comindware Platform {: #quick_start_rag_agent }
