...
**Состав комплекта:** коммерческое резюме для руководства, два основных отчёта (методология; сайзинг и экономика), приложения (A–F), _[единое резюме для руководства](./20260331-research-executive-unified-ru.md)_ для быстрого ознакомления и сейлс-кита, а также два **кратких резюме** в контуре комплекта.
...
| Наблюдаемость (observability) | Возможность разбирать контур по трассам, метрикам, логам и событиям. |
...
| Eval | Контур оценки качества: тестовые наборы, критерии, регрессии и проверка деградации после изменений модели, индекса или промпта. |
...
| MOSEC | Унифицированный HTTP-контур подачи вспомогательных моделей: эмбеддингов, реранка, защитных проверок и смежных сервисов. |
...
| vLLM | Высокопроизводительный контур инференса больших языковых моделей; в пакете — один из базовых вариантов промышленной подачи LLM. |
...
| Экономика: цифры, тарифы, сценарии сайзинга, CapEx / OpEx / TCO | [Отчёт «Сайзинг и экономика (CapEx / OpEx / TCO)»](./20260325-research-report-sizing-economics-main-ru.md#sizing_pack_overview) |
...
| Назначение | Документ |
| --- | --- |
| SCQA по методологии внедрения, TOM, суверенитету и происхождению практики | [«Методология разработки и внедрения ИИ»](./20260325-research-report-methodology-main-ru.md#method_scqa) |
| SCQA по TCO, CapEx/OpEx, сценариям РФ, валюте и границам применимости глобальных бенчмарков | [«Сайзинг и экономика (CapEx / OpEx / TCO)»](./20260325-research-report-sizing-economics-main-ru.md#sizing_scqa) |
...
| **Сводка по карте GenAI (ноябрь 2025)** | [Отчёт «Методология разработки и внедрения ИИ»](./20260325-research-report-methodology-main-ru.md#method_genai_map_nov2025_metrics_extract) |
...
| **Бенчмарки RTX 4090 (24 и 48 ГБ)** | [Отчёт «Сайзинг и экономика (CapEx / OpEx / TCO)»](./20260325-research-report-sizing-economics-main-ru.md#sizing_rtx_4090_benchmarks) |
...
| **Практические рекомендации по сайзингу (дерево решений)** | Отчёт «Сайзинг и экономика (CapEx / OpEx / TCO)» |
| **Новые тренды 2026 (Дополнительно)** | Отчёт «Сайзинг и экономика (CapEx / OpEx / TCO)» |
| **Планирование мощности ИИ-инфраструктуры (2025-2030)** | Отчёт «Сайзинг и экономика (CapEx / OpEx / TCO)» |
...
## Часть IV. Дополнительное чтение {: #app_a_additional_sources_backlog }
...
!!! note "Как пользоваться дополнительным чтением"
    ...
    Если нужен **канонический** источник для ссылки в самом комплекте, сначала смотрите **часть III**.
    Если нужен внешний бенчмарк, дополнительный кейс или ориентир для обновления повестки, переходите в **Приложение F**.
