...
- Где примерные расчёты расхода токенов по данным портала поддержки и допущениям? → параграф _«[Примерные расчёты расхода токенов по данным корпуса заявок (портал поддержки)](./20260325-research-report-sizing-economics-main-ru.md#sizing_token_consumption_estimates)» отчёта «Сайзинг и экономика»_.
...
- [Yandex AI Studio — прайсинг и модельная галерея (2026)](https://aistudio.yandex.ru/docs/ru/ai-studio/pricing.html)
