...
| Защитные проверки | Набор ограничений и проверок вокруг модели: политики ответа, фильтры, валидация формата и правила безопасного вызова инструментов. |
| Эксплуатационный регламент | Описание штатной эксплуатации, инцидентов, типовых проверок и действий сопровождения. |
| Открытые весы модели | Опубликованные веса модели, которые можно развернуть в своём контуре; это не тождественно отсутствию лицензионных ограничений. |
