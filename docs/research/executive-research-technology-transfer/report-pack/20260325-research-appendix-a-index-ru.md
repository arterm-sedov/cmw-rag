...
**Состав комплекта:** два основных отчёта (методология; сайзинг и экономика), приложения (A–E) и _[единое резюме для руководства](./20260331-research-executive-unified-ru.md)_ для быстрого ознакомления и сейлс-кита.
...
В тексте комплекта **корпоративный RAG-контур**, **сервер инференса на базе MOSEC/vLLM**, агентный слой **Comindware Platform** — **условные названия ролей** референс-стека.
...
| MOSEC | Унифицированный HTTP-сервис для хостинга любых моделей (например, эмбеддеров, реранкеров, охранников), в том числе через SentenceTransformers и vLLM |
