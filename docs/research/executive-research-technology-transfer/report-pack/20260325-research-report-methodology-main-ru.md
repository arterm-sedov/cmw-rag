...
Для **пилотов линии поддержки** используйте _[примерные расчёты расхода токенов](./20260325-research-report-sizing-economics-main-ru.md#sizing_token_consumption_estimates)_ из публичного корпуса заявок.
