...
- **сервер инференса MOSEC** — управление процессом, YAML-реестр моделей, воркеры эмбеддинга/реранкера/охранника на **одном HTTP-порту**. CLI: установка, запуск, статус, остановка, тестирование.
- **инференс на базе vLLM** — жизненный цикл процессов, pooling-режимы для эмбеддингов/скоринга, YAML-реестр, выгрузка KV-кэша через LMCache (vLLM v1).
