...
- **Парадигма:** зафиксировать границы допустимой агентности — что агент вправе делать самостоятельно, а что требует подтверждения человеком; переход от детерминированной логики к вероятностной системе с измеримыми результатами.
