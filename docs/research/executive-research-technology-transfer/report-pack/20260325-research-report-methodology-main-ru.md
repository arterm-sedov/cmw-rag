...
Для **пилотов линии поддержки** полезно опереться на **примерные расчёты расхода токенов**, полученные из доступных данных по публичному корпусу заявок с портала поддержки: таблицы, допущения по переводу слов в токены и разводку **целевой цены за тикет** и **верхней модельной оценки цикла** — в _«[Отчёте по сайзингу и экономике — примерные расчёты расхода токенов](./20260325-research-report-sizing-economics-main-ru.md#sizing_token_consumption_estimates)»_.
...
- **Коммерческая цель:** использовать единый набор проверяемых аргументов в пресейле и в переговорах о передаче (KT/IP), согласовывая тарифные цифры с _«[Отчётом по сайзингу и экономике](./20260325-research-report-sizing-economics-main-ru.md#sizing_russian_ai_cloud_tariffs)»_ (без расхождений между материалами комплекта).
- **Принцип чтения блока:** здесь фиксируются роли провайдеров, составы модельных линеек и правила сверки SKU; расчётные значения и сценарный сайзинг — в _«[Отчёте по сайзингу и экономике](./20260325-research-report-sizing-economics-main-ru.md#sizing_russian_ai_cloud_tariffs)»_.

!!! tip "Тарифы и сценарный сайзинг для переговоров"

    Для расчётов и ценовых сравнений опирайтесь на _«[Отчёт по сайзингу и экономике — тарифы российских облачных провайдеров ИИ](./20260325-research-report-sizing-economics-main-ru.md#sizing_russian_ai_cloud_tariffs)»_: количественные тарифы (руб. за токены, комплекты, руб./час GPU), дерево факторов стоимости и сценарный сайзинг.
...
- **Тарификация:** оплата **по токенам** (входные и генерируемые — отдельно, см. [официальный прайс](https://cloud.ru/documents/tariffs/evolution/foundation-models)). **Все ₽/млн и расшифровка по строкам** (в т.ч. GigaChat3-10B-A1.8B, Qwen3-235B, GigaChat-2-Max, GLM-4.6, MiniMax-M2) — в _«[Отчёте по сайзингу и экономике — тарифы российских облачных провайдеров ИИ](./20260325-research-report-sizing-economics-main-ru.md#sizing_russian_ai_cloud_tariffs)»_; маркетинговый перечень на сайте может быть **шире** прайса на дату сверки.
...
- **Тарифы:** первоисточник — [правила тарификации AI Studio](https://aistudio.yandex.ru/docs/ru/ai-studio/pricing.html): таблица Model Gallery, ₽ **с НДС** за **1000** токенов (входящие, кеш, инструменты, исходящие); для агентов — отдельно токены инструментов. Эквиваленты **₽/млн** и строки по моделям — в _«[Отчёте по сайзингу и экономике — тарифы российских облачных провайдеров ИИ](./20260325-research-report-sizing-economics-main-ru.md#sizing_russian_ai_cloud_tariffs)»_. Публикации СМИ (например, ориентиры порядка ~0,5 ₽ за 1000 токенов) — для справки; для КП использовать только официальный прайс на дату сверки.
...
Все **числовые** ориентиры по управляемым API — в _«[Отчёте по сайзингу и экономике — тарифы российских облачных провайдеров ИИ](./20260325-research-report-sizing-economics-main-ru.md#sizing_russian_ai_cloud_tariffs)»_. Отдельно Сбер публикует **открытые веса** GigaChat‑3.1‑Ultra и Lightning под **MIT** ([Хабр](https://habr.com/ru/companies/sberbank/articles/1014146/)): экономика смещается в **CapEx/OpEx GPU** — см. _«[Отчёт по сайзингу и экономике — открытые веса и API: влияние на TCO](./20260325-research-report-sizing-economics-main-ru.md#sizing_open_weights_api_tco_impact)»_.
...
Если **сценарий проверки** использует браузерную автоматизацию, снимки экрана или прогон против стендов с чувствительными данными, действуют те же принципы, что и для телеметрии генеративного ИИ: **минимизация**, сроки хранения артефактов, контур хранения и матрица доступа — см. _«[Приложение D — периметр до LLM: минимизация данных](./20260325-research-appendix-d-security-observability-ru.md#app_d__llm_perimeter_data_minimization)»_ и _«[Приложение D — персональные данные и содержимое в телеметрии](./20260325-research-appendix-d-security-observability-ru.md#app_d__personal_data_telemetry_152fz)»_. Новые нормативные тезисы здесь не вводятся.
...
**Связь с FinOps:** мультиагентные циклы и длительные прогоны разработки увеличивают **токены и wall-clock**; ориентиры по закладке в TCO — в _«[Отчёте по сайзингу и экономике — FinOps и юнит-экономика нагрузки](./20260325-research-report-sizing-economics-main-ru.md#sizing_finops_unit_economics)»_.
...
Опорные элементы публичной **карты сегментов** GenAI (red_mad_robot, ноябрь 2025) ниже сопоставлены с разборами **ИИ-рынка России** в _«[Отчёте по сайзингу и экономике](./20260325-research-report-sizing-economics-main-ru.md#sizing_russia_ai_market_stats_forecasts)»_ и с блоками **«Российские модели»** и **«Применение ИИ-агентов»** выше в этом документе. Колонка **«Источник и граница применимости»** фиксирует основание для процентных ориентиров и условия, при которых они могут расходиться с PDF карты при иной выборке или формулировке метрики.

| Метрика / сегмент | Как отражено в комплекте | Уверенность | Источник и граница применимости |
| --- | --- | --- | --- |
| Онтология сегментов (инфраструктура / модели / продукты / интеграция) | абзац **Онтология сегментов** выше в этом разделе | высокая | сводка по публичным материалам red_mad_robot и смежным отраслевым обзорам 2025 |
| Сценарный контур до 2030 | три логические ветки стресс-теста, без baseline КП | средняя | обзорные материалы red_mad_robot; количественные ряды — в _«[Основной отчёт: сайзинг — ИИ-рынок России](./20260325-research-report-sizing-economics-main-ru.md#sizing_russia_ai_market_stats_forecasts)»_ |
...
**Управление изменениями:** крупные отраслевые обзоры подчёркивают, что **организационный** контур (процессы, данные, компетенции, измеримость) часто определяет итог сильнее, чем выбор одной модели — см. [McKinsey — The state of AI](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai). Поведенческие и организационные риски — в _«[Стратегия внедрения ИИ и организационная зрелость](./20260325-research-report-methodology-main-ru.md#method_ai_strategy_org_maturity)_»_ и _«[Приложение D — организационные и поведенческие факторы риска](./20260325-research-appendix-d-security-observability-ru.md#app_d__org_behavioral_risk_factors)_»_. Термин **AI TRiSM** (доверие к ИИ-системам) и сметные последствия — _«[Приложение D — AI TRiSM](./20260325-research-appendix-d-security-observability-ru.md#app_d__ai_trism_trust_management)_»_ и _«[Отчёт по сайзингу и экономике — OpEx безопасности GenAI](./20260325-research-report-sizing-economics-main-ru.md#sizing_genai_security_opex)_»_.
...
Сводные **цифры по токенам** (Cloud.ru, Yandex AI Studio, комплекты SberCloud, примечания MWS/Selectel) собраны в _«[Отчёте по сайзингу и экономике — тарифы российских облачных провайдеров ИИ](./20260325-research-report-sizing-economics-main-ru.md#sizing_russian_ai_cloud_tariffs)»_; в этом документе — роли провайдеров, архитектура доступа к моделям и матрица API vs open weights (подраздел **Российские облачные провайдеры ИИ** выше).

**Открытые веса** GigaChat‑3.1 (MIT, HF/GitVerse — см. [Хабр](https://habr.com/ru/companies/sberbank/articles/1014146/)) переносят основную стоимость в **инфраструктуру и эксплуатацию**; вилка TCO — в _«[Отчёте по сайзингу и экономике — открытые веса и API: влияние на TCO](./20260325-research-report-sizing-economics-main-ru.md#sizing_open_weights_api_tco_impact)»_.
