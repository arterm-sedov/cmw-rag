...
| **Сервер инференса (унифицированный)** | **На базе MOSEC** | Обслуживание специализированных моделей: эмбеддинга, реранкера и охранника | MOSEC, PyTorch |
...
| VK Cloud ML | Нет LLM‑каталога в доке | BYO на ML Platform | Инфраструктура под **сервер инференса на базе MOSEC/vLLM** |
