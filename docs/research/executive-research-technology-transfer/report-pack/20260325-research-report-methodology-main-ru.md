...
Предыдущий раздел фиксирует **данные и рабочий слой** как источник преимущества; ниже — **организационная** сторона: без неё доступ к моделям и пилоты редко переходят в устойчивый эффект в P&L. Это **согласуется** с выводами BCG о том, что около **10%** ценности ИИ дают сами алгоритмы, ещё **20%** — технологический контур внедрения, а оставшиеся **70%** — изменения в людях, ролях и способе работы ([BCG, 2026](https://www.bcg.com/publications/2026/ai-transformation-is-a-workforce-transformation)). В логике McKinsey то же видно через дефицит перестройки процессов: лишь **21%** организаций, уже использующих GenAI, сообщили о фундаментальной переработке хотя бы части workflow ([McKinsey, 2025](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai-how-organizations-are-rewiring-to-capture-value)). Поэтому **центр трансформации** — способность компании **переобучать команды, пересобирать роли и закреплять новые практики** в ежедневной работе, а не только выбор стека.
