...
!!! question "Определения"
    ...
    - **Оркестратор** — программный слой, координирующий вызовы LLM, инструментов и внешних API. Управляет конвейером обработки, обрабатывает ошибки и повторы.
...
### Граница ответственности: LLM и оркестратор {: #llm_orchestrator_boundary }
...
### Взаимодействие компонентов {: #component_interaction }
...
### Конвейер обработки {: #processing_pipeline }
...
### Асинхронная модель взаимодействия {: #async_interaction_model }
...
### Декларативная конфигурация {: #declarative_config }
...
### Атрибуты и возможности агента {: #agent_attributes_capabilities }
...
### Гибкость промптов {: #prompt_flexibility }
...
### Программный интерфейс {: #api_interface }
...
### Пример вызова агента со стороны Comindware Platform {: #api_example }
