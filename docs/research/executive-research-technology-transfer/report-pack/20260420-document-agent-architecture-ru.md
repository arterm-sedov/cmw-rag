...
| :--- | :--- | :--- | :--- |
| **Comindware Platform** | Внешний | Источник документов и получатель результатов | Бизнес-приложение на основе low-code |
...
| **Вывод** | Трансляция | Запись итоговых данных в атрибуты записи, форматирование HTML, приведение типов между агентом и платформой | Comindware Platform REST API |
