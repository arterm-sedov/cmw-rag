---
title: 'Приложение D. Рыночные и технические сигналы'
date: '2026-04-06'
status: 'v2'
tags:
    - архитектура
...
# Приложение D. Рыночные и технические сигналы {: #app_e_pack_overview }

## Стратегический контекст {: #app_e_overview }
...
Комплаенс, модель угроз и наблюдаемость — в _Приложении C «[Безопасность, комплаенс, наблюдаемость](./20260325-research-appendix-d-security-observability-ru.md#app_d_pack_overview)»_.

## Инвестиционные ориентиры {: #app_e_how_to_use }
...
## Продуктовый радар и архитектурные векторы {: #app_e_architecture_product_radar }

Модель угроз и 152-ФЗ для **корпоративного RAG-контура** — _Приложение C «[Безопасность, комплаенс](./20260325-research-appendix-d-security-observability-ru.md#app_d_agents_tools_memory_observability)»_.

Сводка трендов — _«[Тренды 2026 года](#app_e_trends_2026_summary)»_.

### GraphOS: высокоуровневая архитектура RAG {: #app_e__graphos_rag_16_layer_architecture }
...
- Устойчивый спрос на **сквозную наблюдаемость GenAI** (трассировка, токенизация, оценка качества в продакшне) в **self-hosted** и резидентных контурах — _Приложение C, параграф «[Рынок РФ, наблюдаемость LLM и референс-стек Comindware](./20260325-research-appendix-d-security-observability-ru.md#app_d_russia_llm_observability_phoenix_reference)»_
...
**Китайские альтернативные GPU:** Huawei Ascend 910C (~80% H100, $12–18 тыс.), Moore Threads Huashan (прогноз 2026), Cambricon Siyuan 590 (192 GB), MetaX, цепочки поставок для России/CIS и рекомендации по внедрению, см. _Приложение E «[Китайские альтернативные GPU для  инференса](./20260410-research-appendix-g-chinese-gpu-alternatives-ru.md#app_g_pack_overview)»_.
...
- **Результат:** зрелость агентных паттернов в SDLC; для заказчика критичны ИБ (доступ к репозиториям, журналирование, контроль действий агента) и модель отчуждения — см. _Приложение A «[Отчуждение ИС и кода](./20260325-research-appendix-b-ip-code-alienation-ru.md#app_b_customer_guidelines_dev_acceleration)»_.
...
- **Результат:** для стратегии это маркер темпа рынка агентных ИИ-систем; для промышленного внедрения ключевой вопрос остаётся тем же: изоляция среды, аудит действий агента и границы допустимой автономии. Контур риска и публичные сигналы экспозиции сохранены в Приложении C.
...
_Это публичные ориентиры для рыночного сравнения, а не каноническая строка сметы. Для бюджетирования и TCO используйте отчёт «[Сайзинг и экономика (CapEx / OpEx / TCO)](./20260325-research-report-sizing-economics-main-ru.md#sizing_overview)»._ 
