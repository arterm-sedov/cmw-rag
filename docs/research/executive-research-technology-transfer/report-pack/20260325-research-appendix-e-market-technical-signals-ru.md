...
Комплаенс, модель угроз и наблюдаемость — в _Приложении D «[Безопасность, комплаенс, наблюдаемость](./20260325-research-appendix-d-security-observability-ru.md#app_d_pack_overview)»_.
...
Значения CapEx/OpEx и SLA по данным сигналам подтверждаются через дерево факторов стоимости, сценарный сайзинг и российские тарифы в отчёте _«[Сайзинг и экономика (CapEx / OpEx / TCO)](./20260325-research-report-sizing-economics-main-ru.md)»_.
