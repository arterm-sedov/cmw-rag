...
**Китайские GPU-альтернативы:** Huawei Ascend 910C (~80% H100, $12–18 тыс.), Moore Threads Huashan (прогноз 2026), Cambricon Siyuan 590 (192 GB), MetaX, цепочки поставок для России/CIS и рекомендации по внедрению, см. _Приложение G «[Китайские GPU-альтернативы для AI-инференса](./20260410-research-appendix-g-chinese-gpu-alternatives-ru.md#app_g_pack_overview)»_.
