...
### Агенты для разработки (IDE/CLI-агенты) {: #sizing_coding_agents }
...
## Рынок ИИ: статистика a16z (март 2026) {: #sizing_ai_market_a16z_stats }
...
### Слои ИИ-инфраструктуры {: #sizing_ai_infrastructure_layers }
...
### Капитальные затраты крупных техкомпаний (2025) {: #sizing_big_tech_capex_2025 }
