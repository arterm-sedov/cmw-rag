...
date: "2026-03-29"
status: "приложение (v1, март 2026)"
tags:
  - приложение
  - справочно
  - рынок
...
- Коммерческое резюме для руководства: [«Корпоративный ИИ для промышленного предприятия — предложение Comindware»](./20260325-comindware-ai-commercial-offer-ru.md)
- Методология и TOM: [Основной отчёт — методология](./20260325-research-report-methodology-main-ru.md#method_pack_overview)
- Экономика и TCO: [Основной отчёт — сайзинг и экономика](./20260325-research-report-sizing-economics-main-ru.md#sizing_pack_overview)
...
- BitNet и 1‑битный инференс для продакшена на CPU
...
#### Общая картина рынка GenAI (red_mad_robot, ноябрь 2025) {: #app_e_rmr_market_map_2025 }

**Ключевые метрики:**

| Метрика | Значение | Контекст |
|---------|----------|----------|
| B2B-адаптация | **70%** | Быстрая окупаемость (поддержка, знания, труд) |
| Кадровый дефицит | **~10 тыс.** | M&A + обучение |
| B2C | **84%** осведомлённость; **29%** LLM-поиск (**47%** молодёжь) | Практическая зрелость РФ |
| ROI on-prem | **3+ года** | Cloud для пилотов, ЦОД для prod (Билайн) |

**Онтология рынка:**

- Ядро: данные (LabelMe), модели (GigaChat/YandexGPT), инструменты.
- Инфра: GPU/облака (3Logic/DataRu); китайские альтернативы.
- Услуги: AI-TRISM/консалтинг.

_Источник:_ PDF «Карта рынка GenAI» (red_mad_robot, ноябрь 2025).
...
**Вывод для стратегии:** Comindware позволяет «арендовать» экспертизу и суверенный стек (MOSEC/vLLM), обходя необходимость найма дефицитных кадров на перегретом рынке.

#### GenAI в маркетинге (CMO Club × RMR, 2025) {: #app_e_cmo_marketing_2025 }
...
- **Эффекты (по тем же открытым материалам):** **77%** отмечают рост скорости и качества контента; **73%** — ускорение процессов в целом; **50%** — рост продуктивности без расширения штата; **43%** — снижение нагрузки на команды.
...
### Рекомендации по выбору железа {: #app_e_hardware_selection_guide }
...
## Рынок ИИ: статистика a16z (март 2026) {: #app_e_ai_market_a16z_stats }

**Источник:** a16z Top 100 AI Apps [[источник]](https://a16z.com/100-gen-ai-apps-6/)

### Распределение рынка {: #app_e_market_distribution }
...
### Цены на инференс (Cursor) {: #app_e_inference_pricing_cursor }

| Модель | Вход (руб./1M ток.) | Выход (руб./1M ток.) |
|--------|---------------------|----------------------|
| Cursor Composer 2 | ~42,5 | ~212,5 |
| Opus 4.6 (ориентир прямого API Anthropic) | ~425 | ~2 125 |
| Sonnet 4.6 (ориентир прямого API Anthropic) | ~255 | ~1 275 |
| GPT-5.4 | ~850 | ~2 550 |

!!! note "Примечание"

    Cursor утверждает, что Composer 2 сопоставим по качеству с топовыми моделями, но существенно дешевле. Публичные прайсы меняются; для КП фиксируйте дату и валюту контракта.
...
### Новости индустрии (Март 2026) {: #app_e_industry_news_march_2026 }

Сводка моделей, инструментов и рыночных сигналов.
...
**Вывод для бюджетирования:** для продакшн-инференса ориентируйтесь на **NVIDIA (vLLM/TensorRT-LLM)** или **AMD MI300X (ROCm vLLM)** с учётом конвертации моделей. Apple Silicon и GGUF — для edge/R&D. Тарифы GPU РФ — в _«[Отчёте. Сайзинг и экономика](./20260325-research-report-sizing-economics-main-ru.md)»_.
...
- [SkillsBD.ru — база навыков РФ](https://skillsbd.ru/)
