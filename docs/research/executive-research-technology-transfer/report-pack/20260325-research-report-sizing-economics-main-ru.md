...
!!! note "Ограничения данных по российскому рынку"
    ...
    Ряд западных аналитических агентств (Gartner, IDC, Statista) прекратили публикацию отдельных отчётов по российскому рынку после 2022 г. Часть приведённых цифр по рынку РФ основана на российских источниках (Коммерсантъ, ВЦИОМ, Yakov & Partners) и требует перекрёстной верификации. При использовании в КП рекомендуется дополнительная проверка актуальных данных на дату предложения.
