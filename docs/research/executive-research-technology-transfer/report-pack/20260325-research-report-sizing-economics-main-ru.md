...
| Модель GPU | VRAM | FP16/BF16 | Покупка (Карта), руб. | Сервер/WS (1 GPU), руб. | Аренда, руб./час |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
_Курс USD/RUB и правила пересчёта — см. [приложение A](./20260325-research-appendix-a-index-ru.md#app_a_fx_policy)._
...
_Курс USD/RUB и правила для смет — см. [приложение A](./20260325-research-appendix-a-index-ru.md#app_a_fx_policy)._
...
**Вывод:** Оптимизации могут снизить требования к железу на 30-70% без потери качества. См. детальный разбор в [разделе «Риски и оптимизация»](#sizing_risks_and_optimization).
...
Актуальные AI/ML тренды для стратегического планирования — см. [Приложение E](./20260325-research-appendix-e-market-technical-signals-ru.md#sizing_ai_ml_trends_channel).
