...
Ниже — **внутренняя оценка**: из данных портала поддержки Comindware выведены средние длины и ориентиры по токенам и рублям (корпус **14 437** заявок).

Перевод **слов → токены:** русский ~2 токена на слово, английский ~0,67. Для точного подсчёта используйте токенизатор конкретной модели.
...
| Сценарий | RAG | Заявка | Ответ | Рассуждение | Всего ток. | Ориентир, руб. (~300 ₽/млн) |
|:---|---:|---:|---:|---:|---:|---:|
