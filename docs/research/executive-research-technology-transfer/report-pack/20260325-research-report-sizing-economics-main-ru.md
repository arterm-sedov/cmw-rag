...
|--------|---------------|----------------|-----------|
| GigaChat 3.1 Lite | 65 | 65 | Обновлено февраль 2026 (↓3 раза) |
| GigaChat 3.1 Pro | 500 | 500 | Обновлено февраль 2026 |
| GigaChat 3.1 Max | 650 | 650 | Обновлено февраль 2026 |
| Qwen3-235B | 20,74 | 20,74 | Open-source |
| MiniMax-M2 | 40,26 | 158,6 | |

!!! note "Снижение цен ГигаЧат"

    В феврале 2026 года Сбер объявил о **трёхкратном снижении** цен на API GigaChat. Текущие цены актуальны на март 2026.

#### Yandex AI Studio (Alice AI / YandexGPT) {: #sizing_yandex_cloud_ai_studio }

| Модель | Вход (₽/млн) | Выход (₽/млн) | Примечание |
|--------|---------------|----------------|-----------|
| YandexGPT 5 Pro | **Бесплатно** | **Бесплатно** | Через Алису и браузер с июля 2025 |
| YandexGPT 5 Lite | **Бесплатно** | **Бесплатно** | Через Алису и браузер |
| YandexGPT 5.1 API | По запросу | По запросу | Корпоративные контракты |

!!! note "Бесплатный доступ Яндекса"

    С июля 2025 года YandexGPT доступен бесплатно через Алису и Яндекс Браузер. API через Yandex Cloud — по индивидуальному контракту.

#### SberCloud (GigaChat API) {: #sizing_sbercloud_gigachat_api }

- **GigaChat 3.1 Lite:** 65 ₽/млн (пакет 1 млрд)
- **GigaChat 3.1 Pro:** 500 ₽/млн
- **GigaChat 3.1 Max:** 650 ₽/млн

!!! note "Примечание: различие цен Cloud.ru и SberCloud"

    Цены Сбера едины для обеих платформ после снижения в феврале 2026 года. На Cloud.ru также доступны другие модели (Qwen3, MiniMax) по различным ценам. Для КП сверять актуальный прайс провайдера.
