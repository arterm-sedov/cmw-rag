...
### 1.3 Матрица принятия решений (РБК 2026) {: #sizing_decision_matrix }
...
## 2. Рыночный контекст {: #sizing_market_context }
...
## 3. Тарифы и провайдеры РФ {: #sizing_russian_ai_cloud_tariffs }
...
## 4. Экономический каркас {: #sizing_economic_framework }
...
## 5. Модель затрат {: #sizing_cost_model }

### 5.1 Ценовые сегменты внедрения ИИ-агентов {: #sizing_ai_agent_price_segments }
...
## 9. Риски и оптимизация {: #sizing_risks_and_optimization }

### 9.1 Сборник мер по оптимизации стоимости (Cost Optimization Suite) {: #sizing_cost_optimization_suite }
...
## 6. Аппаратные требования и кейсы {: #sizing_hardware_requirements_and_cases }

### 6.1 Профиль on-prem GPU в проектах Comindware {: #sizing_onprem_gpu_profile_cmw }
...
## 7. Детальные затраты и TCO {: #sizing_detailed_costs_tco }

### 7.1 Локальное развертывание {: #sizing_local_deployment }
...
## 8. Рекомендации по сайзингу {: #sizing_recommendations }

### 8.1 Малый бизнес / Департамент {: #sizing_small_business_department }
...
### 8.2 Среднее предприятие {: #sizing_medium_enterprise }
-   **Оборудование:** RTX 6000 Ada / PRO 6000 Blackwell или 2× RTX 4090 Workstation
...
### 8.3 Крупное предприятие {: #sizing_large_enterprise }
-   **Оборудование:** NVIDIA A100/H100 Server (4-8 GPU)
...
### 8.4 Оптимизация инференса и выбор моделей {: #sizing_inference_optimization_recommendations }
...
### 8.5 Дополнительные стратегии оптимизации затрат {: #sizing_additional_cost_optimization_strategies }
...
## 10. Тренды и планирование {: #sizing_trends_and_planning }

### 10.1 Актуальные AI/ML тренды {: #sizing_trends_summary }

Актуальные AI/ML тренды для стратегического планирования — см. _[Приложение E](./20260325-research-appendix-e-market-technical-signals-ru.md#sizing_ai_ml_trends_channel)_.

## 11. Заключение и обоснование {: #sizing_conclusion_justification }
