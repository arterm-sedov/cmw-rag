...
!!! note "Цены Сбера"
    ...
    Актуальны на март 2026. Цены едины для Cloud.ru и SberCloud. GigaChat 3.1 (MIT) — на Hugging Face.
...
**Вывод:** оптимизации могут снизить требования к железу на 30-70% без потери качества. См. детальный разбор в разделе _«[Риски и оптимизация](#sizing_risks_and_optimization)»_.
...
- Полный консолидированный реестр — см. _«[Обзор и ведомость документов](./20260325-research-appendix-a-index-ru.md#app_a_sources_registry)»_.
