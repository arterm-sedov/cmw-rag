...
## Введение и резюме {: #sizing_intro_and_summary }
...
### Матрица аргументов по ролям ЛПР заказчика {: #sizing_c_role_decisions }
...
| **CFO** | Бюджет, TCO и владение активами | CapEx / OpEx границ | Оптимизация TCO: после 12–18 месяцев владение собственным контуром становится выгоднее подписки на внешние SaaS. |
...
#### Распределение AI-сервисов среди россиян (ВЦИОМ, 2025)
...
#### Барьеры и эффекты внедрения (глобальные показатели)
