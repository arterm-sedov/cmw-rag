...
## Введение и резюме для руководства {: #sizing_intro_and_summary }
...
- **Рекомендуемый ответ:**
    ...
    - измеримый бизнес‑эффект требует **организации зрелости** — см. отчёт _«[Методология внедрения и разработки](./20260325-research-report-methodology-main-ru.md#method_ai_strategy_org_maturity)»_; финальные цифры КП — после прайса провайдера на дату и, для on‑prem, замеров на целевом стеке.
...
### Ключевые решения по ролям {: #sizing_c_role_decisions }

| Роль | Что важно | Решение | Аргумент из комплекта |
| :--- | :--- | :--- | :--- |
| **CEO** | P&L, капитализация и независимость | Го/нет-го на PoC → Pilot → Scale | ИИ как нематериальный актив: рост стоимости компании за счёт владения уникальными моделями и защищённым контуром. |
...
| **CRO** | Упаковка для клиента и продажи | Выбор пакета (PoC / Pilot / Scale / BOT) | Отчуждение как ценность: клиент получает суверенный актив и экспертизу, а не только доступ к API. |
...
- Пиковое потребление токенов -50% (вдвое — см. _«[Отчёт. Методология внедрения и разработки](./20260325-research-report-methodology-main-ru.md#method_ai_agent_memory_context)»_)
- Успешность в **ALFWorld** в материалах авторов: **24,2%** → **85,6%**

### Databricks KARL

- Корпоративный поиск с RL (KARLBench, Agentic Synthesis, OAPL — см. _«[Отчёт. Методология внедрения и разработки](./20260325-research-report-methodology-main-ru.md#method_ai_agent_memory_context)»_).
