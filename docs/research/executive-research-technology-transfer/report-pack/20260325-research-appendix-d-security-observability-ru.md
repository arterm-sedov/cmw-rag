...
**Корпоративный LLM-шлюз (справочно):** архитектура и эксплуатационные соображения по платформе **MWS GPT** изложены в публичной статье ([Хабр, МТС](https://habr.com/ru/companies/ru_mts/articles/967478/)); тарифы и TCO по токенам — в _«[Отчёте по сайзингу и экономике — тарифы российских облачных провайдеров ИИ](./20260325-research-report-sizing-economics-main-ru.md#sizing_russian_ai_cloud_tariffs)»_.
...
**Практика:** перечень и меры смягчения пересматривать **не реже чем раз в квартал** или при смене модели, инструментов агента и политики данных; количественные оценки вреда закладывать в _«[Отчёт по сайзингу и экономике — риски бюджета](./20260325-research-report-sizing-economics-main-ru.md#sizing_budget_risks_mitigation)»_ и связанные строки TCO.
...
**Практика:** при появлении или смене **инструментов, MCP, оркестрации и межагентских протоколов** пересматривать сценарии тестирования **наряду** с [LLM Top 10 2025](https://genai.owasp.org/resource/owasp-top-10-for-llm-applications-2025/); для заказчиков с агентный слой **Comindware Platform** и сложной маршрутизацией агентов оба перечня обязательны к учёту в модели угроз и смете — _«[Отчёт по сайзингу и экономике — OpEx безопасности GenAI](./20260325-research-report-sizing-economics-main-ru.md#sizing_genai_security_opex)»_.
