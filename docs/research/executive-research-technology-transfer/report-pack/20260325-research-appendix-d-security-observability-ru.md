---
title: 'Приложение C. Безопасность, комплаенс, наблюдаемость'
date: '2026-04-06'
status: 'v2'
tags:
    - GenAI
...
# Приложение C. Безопасность, комплаенс, наблюдаемость {: #app_d }
...
Ориентиры по рынку, стеку и дорожной карте — в _Приложении D «[Рыночные и технические сигналы](./20260325-research-appendix-e-market-technical-signals-ru.md#app_e_pack_overview)»_.
...
## Стратегия промышленной наблюдаемости ИИ {: #app_d_llm_rag_agent_observability .pageBreakBefore }
...
Публичные материалы исследования **CMO Club Russia × red_mad_robot** фиксируют не только технические, но и **организационные** причины, по которым маркетинговые команды остаются на уровне экспериментов: непрозрачный **ROI**, слабая **стратегия** и опасения по **ИБ**. Полный набор долей и формулировок — в отчёте _«[Зрелость российского рынка GenAI](./20260325-research-report-sizing-economics-main-ru.md#sizing_russian_market_maturity)»_; здесь — связка с контуром контроля и OWASP GenAI.
...
Для заказчика в этом блоке значимы только те сигналы, которые меняют требования к **модели угроз**, эксплуатации и комплекту отчуждения; расширенный обзор рынка и продуктовых сигналов вынесен в _«[Приложение D — рыночные и технические сигналы](./20260325-research-appendix-e-market-technical-signals-ru.md#app_e_architecture_product_radar)»_.
...
Краткие обзоры **GraphOS**, **Nested Learning**, **LEANN** и **Perplexica** вынесены в _Приложение D «[Рыночные и технические сигналы](./20260325-research-appendix-e-market-technical-signals-ru.md#app_e_architecture_product_radar)»_. В этом приложении сохраняются только их последствия для контроля: глубина агентского цикла, изоляция среды, требования к телеметрии, долговременной памяти и минимизации данных.
...
Финансовые последствия каждого класса риска — см. в параграфе _«[Риски внедрения ИИ-проектов](./20260325-research-report-sizing-economics-main-ru.md#sizing_ai_implementation_risks)»_ в отчёте по сайзингу.
