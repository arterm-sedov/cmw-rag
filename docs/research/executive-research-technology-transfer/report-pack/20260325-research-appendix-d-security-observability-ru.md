...
**Централизованный реестр MCP-серверов** (иллюстрация инженерной дисциплины, не часть SKU **Comindware**): в открытом контуре red_mad_robot описывают **MCP Tool Registry** как способ связать LLM с данными и инструментами при сборке RAG- и агентных сценариев; исходный код выложен отдельным репозиторием. Для заказчика смысл — не «ещё один продукт», а напоминание про **каталог допустимых серверов**, согласование версий и аудит подключений в одной матрице с allowlist и секретами из комплекта отчуждения — _«[Приложение B — IP, код и отчуждение](./20260325-research-appendix-b-ip-code-alienation-ru.md#app_b_ai_assets_alienation_methodology)»_. Первичные ссылки — в разделе «Источники» этого приложения и _«[Отчёта по методологии](./20260325-research-report-methodology-main-ru.md#method_pack_overview)»_.
