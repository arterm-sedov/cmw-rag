...
- Для ПДн по умолчанию применять **минимизацию**: не логировать полный контент в телеметрию; хранить контент отдельно с контролем доступа (см. раздел про 152‑ФЗ и рекомендации OpenTelemetry).
...
- **Связка с телеметрией:** даже при корректной архитектуре спанов организация может **логировать избыточно** из культуры «сохранить всё»; управленческий барьер «безопасность и данные» из того же исследования усиливает требование к **явной политике** сэмплинга и ретенции, согласованной с ДПО.
