...
**Централизованный реестр MCP-серверов:** в открытых материалах red_mad_robot **MCP Tool Registry** позиционируется как способ связать LLM с данными и инструментами в RAG- и агентных сценариях (исходный код — отдельный репозиторий). Для заказчика это усиливает аргумент **управляемого периметра**: **единый перечень допустимых MCP-серверов**, согласованные ревизии и **аудит подключений** в одной плоскости с allowlist и управлением секретами в комплекте отчуждения — _Приложение B, параграф «[Методология отчуждения ИИ-активов](./20260325-research-appendix-b-ip-code-alienation-ru.md#app_b_ai_assets_alienation_methodology)»_. Первичные ссылки — в разделе «Источники» этого приложения и отчёта _«[Отчёт. Методология разработки и внедрения ИИ](./20260325-research-report-methodology-main-ru.md#method_pack_overview)»_.
...
**Трансграничные шлюзы разработки** (OpenRouter, OpenCode Zen и аналоги) для **продакшн**-решений с ПДн в РФ **не подменяют** маркировку, локализацию и логику реестра — см. _Приложение B, параграф «[Ориентиры для заказчика: инструменты ускорения разработки (вне поставки Comindware)](./20260325-research-appendix-b-ip-code-alienation-ru.md#app_b_customer_guidelines_dev_acceleration)»_ и параграф _«[Зарубежные API (разработка и песочница)](./20260325-research-report-sizing-economics-main-ru.md#sizing_foreign_api_dev_sandbox)» отчёта «Отчёт. Сайзинг и экономика (CapEx / OpEx / TCO)»_.
...
- **Прямые изменения или только артефакты?** запись в репозиторий **напрямую** vs передача **diff** и отчётов на **ревью** (см. _Приложение B, параграф «[Справочно: агент в PR и артефакты вместо прямой записи в ИС](./20260325-research-appendix-b-ip-code-alienation-ru.md#app_b_reference_agent_pr_artifacts)»_);
