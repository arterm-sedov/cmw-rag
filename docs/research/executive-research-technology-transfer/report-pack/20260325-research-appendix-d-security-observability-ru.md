...
Ориентиры **токенов/с** из публикаций сообщества и обзоров полезны лишь для грубой прикидки до замеров; в эксплуатации их следует сопоставлять с метриками времени генерации токенов на целевом стенде. Иллюстративные таблицы по локальному железу и MoE — в «**Отчёт. Сайзинг и экономика**».
