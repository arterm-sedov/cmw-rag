...
Основные отчёты дают **управленческие выводы**, а здесь — детализация для **решений по ИБ и эксплуатации**.
