...
Офлайн- и прод-метрики (RAGAS, DeepEval, MERA, LLM-as-a-judge — см. выше по документу) усиливаются, если инструментирование по **OpenTelemetry/OpenInference** (в т.ч. **Arize Phoenix** в self-hosted референсе Comindware) даёт стабильные **идентификаторы трасс** или сессий, связываемые с оценками, рейтингами пользователей и результатами выборочного разбора. Это даёт регрессии после смены модели, индекса или промпта и обратную связь для дообучения без смешения с необезличенными журналами в публичных облаках.
...
#### Передача продуктового радара в Приложение E {: #app_d__product_radar_handoff }
...
4. **Agentic Supply Chain Vulnerabilities** — компрометация сторонних модулей, промптов, навыков, MCP-серверов и иных артефактов среды исполнения; иллюстративный кейс LiteLLM/Telnyx вынесен в раздел _«[Источники: инцидент LiteLLM и Telnyx](#app_d__litellm_telnyx_incident_2026)»_.
