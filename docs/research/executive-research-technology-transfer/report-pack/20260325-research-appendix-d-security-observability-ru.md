...
**Централизованный реестр MCP-серверов:** в открытых материалах red_mad_robot **MCP Tool Registry** позиционируется как способ связать LLM с данными и инструментами в RAG- и агентных сценариях (исходный код — отдельный репозиторий). Для заказчика это усиливает аргумент **управляемого периметра**: **единый перечень допустимых MCP-серверов**, согласованные ревизии и **аудит подключений** в одной плоскости с allowlist и управлением секретами в комплекте отчуждения — см. _Приложении B, параграф «[Методология отчуждения ИИ-активов](./20260325-research-appendix-b-ip-code-alienation-ru.md#app_b_ai_assets_alienation_methodology)»_. Первичные ссылки — в разделе «Источники» этого приложения и отчёта _«[Отчёт. Методология разработки и внедрения ИИ](./20260325-research-report-methodology-main-ru.md#method_pack_overview)»_.
...
- **Прямые изменения или только артефакты?** запись в репозиторий **напрямую** vs передача **diff** и отчётов на **ревью** (см. _Приложении B, параграф «[Справочно: агент в PR и артефакты вместо прямой записи в ИС](./20260325-research-appendix-b-ip-code-alienation-ru.md#app_b_reference_agent_pr_artifacts)»_);
