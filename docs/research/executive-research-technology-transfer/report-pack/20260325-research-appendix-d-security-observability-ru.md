...
**Трансграничные шлюзы разработки** (OpenRouter, OpenCode Zen и аналоги) для **продакшн**-решений с ПДн в РФ **не подменяют** маркировку, локализацию и логику реестра — см. _«[Приложение B — ориентиры для заказчика: инструменты ускорения разработки](./20260325-research-appendix-b-ip-code-alienation-ru.md#app_b_customer_guidelines_dev_acceleration)»_ и параграф _«[Зарубежные API (разработка и песочница)](./20260325-research-report-sizing-economics-main-ru.md#sizing_foreign_api_dev_sandbox)» отчёта «Отчёт. Сайзинг и экономика (CapEx / OpEx / TCO)»_.
