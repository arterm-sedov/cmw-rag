...
**Status:** Verified current pricing  
**Language:** English
...
## 4. Other Russian LLM Providers

### VK Cloud
- **Status:** Cloud infrastructure available (GPU instances)
- **LLM API:** No dedicated LLM API pricing found as of March 2026
- **Reference:** [VK Cloud Pricing](https://cloud.vk.com/pricing)

### MTS AI (Cotype)
- **Model:** Cotype Pro 2 (business-focused LLM)
- **Status:** Released April 2025
- **Pricing:** Not publicly available; enterprise sales only
