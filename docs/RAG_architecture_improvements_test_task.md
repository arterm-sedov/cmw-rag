...
| Проблема | Решение |
|----------|---------|
| Сложно найти информацию | Гибридный поиск (семантика + ключевые слова) + умное ранжирование |
| Статьи длинные | Автоматическое формирование TLDR и кратких обзоров (саммари) в Wiki, которые авторы могут редактировать |
...
- **Бюджетирование контекста** — если Top-K статей не помещаются в контекстное окно LLM, низкоранговые статьи сжимаются пропорционально рангу с учётом вопроса.
...
| Задача | Реализация |
|--------|------------|
| **Улучшенный поиск** | Гибридный (BM25 + Vector) → Реранкинг с бустами |
