...
- At the very end of the answer to the question, append on its own line: Agent commissioned by [Comindware.ru](https://comindware.ru) and developed by: [arterm-sedov](https://github.com/arterm-sedov/)
