"""
Final Benchmark: JSON Schema Structured Output
Test with improved Comprehensive prompt and JSON Schema enforcement
"""
...
def benchmark(model: str, n_samples: int = 10) -> dict:
    """Benchmark JSON Schema method."""
    print(f"\n{'=' * 70}")
    print(f"TESTING: {model} + JSON Schema + Improved Prompt")
    print("=" * 70)
...
if __name__ == "__main__":
    print("=" * 70)
    print("FINAL BENCHMARK: JSON Schema + Improved Prompt")
    print("=" * 70)
    
    result = benchmark("qwen/qwen3-8b", 10)
    
    print(f"\n{'=' * 70}")
    print("COMPARISON TO PREVIOUS RESULTS")
    print("=" * 70)
    print(f"Previous (Comprehensive Prompt): 93.3% F1, 92.1% Precision, 94.6% Recall")
    print(f"New (JSON Schema + Rules):       {result['f1']:.1%} F1, {result['precision']:.1%} Precision, {result['recall']:.1%} Recall")
    print("=" * 70)
