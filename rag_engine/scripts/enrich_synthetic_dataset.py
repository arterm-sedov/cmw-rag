...
COMPANIES = [
    "ООО Ромашка", "ТехноПром", "АльфаТеч", "ООО ТехноСтрой",
    "Acme IT", "Global Soft", "HC Companies", "Growscape", "Acme Corp"
]

EMAILS = [
    "ivanov@romashka.ru", "smirnov@company.ru", "petrov@techstroy.com",
